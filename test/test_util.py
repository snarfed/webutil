...
""", util.to_xml({'a': {'b': {'c': 'x', 'd': 'y'}, 'e': (2, 3), }}))
  ...
  def test_parse_iso8601(self):
    for str, offset in (
      ('2012-07-23 05:54:49', None),
      ('2012-07-23T05:54:49', None),
      ('2012-07-23 05:54:49Z', 0),
      ('2012-07-23T05:54:49+0000', 0),
      ('2012-07-23 05:54:49-0000', 0),
      ('2012-07-23T05:54:49+0130', 90),
      ('2012-07-23 05:54:49-1300', -780),
  ...
  def test_maybe_iso8601_to_rfc3339(self):
    for input, expected in (
      ...
      ('2012-07-23 05:54:49.321', '2012-07-23 05:54:49.321'),  # doesn't parse
    ):
