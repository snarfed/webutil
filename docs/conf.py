# -*- coding: utf-8 -*-
#
# webutil documentation Sphinx build configuration file.
#
...
# [We specify Sphinx version with the docs extra in pyproject.toml, and tell
...
project = 'webutil'
copyright = '2013-2026, Ryan Barrett'
author = 'Ryan Barrett'
...
latex_documents = [
  (master_doc, 'webutil.tex', 'webutil Documentation',
   'Ryan Barrett', 'manual'),
]
...
man_pages = [
    (master_doc, 'webutil', 'webutil Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'webutil', 'webutil Documentation',
   author, 'webutil', 'One line description of project.',
   'Miscellaneous'),
]
